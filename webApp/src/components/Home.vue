    ...
    <div class="container">
        ...
        <div class="filter-area">
            ...
            <div class="filter-type">
                ...
                <div class="item clearfix">
                    <div class="pre left">类型:</div>
                    <div class="val left">
                    <span v-for="(tab,index) in tabsName2" class="type-item" @click="tabsSwitch(index)" v-bind:class="{active:tab.isActive}">{{tab.title}}
                    </span>
                    </div>
                </div>
            </div>
        ...
        <div class="movie-content">
            <ul class="movie-list clearfix">
                <li v-for="(item,index) in movieData" :key="index" @click="details(item.id)">
                    <div class="movie-img">
        ...
        .filter-type{
            .item{
                ...
                .val{
                    ...
                    .type-item{
                        text-align: center;
                        padding: 0.05rem .12rem 0.05rem .25rem;
                        border-radius: .3rem;
                        margin-right: 1rem;
                    }
                    .active{
